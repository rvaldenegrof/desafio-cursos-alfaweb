<template>
  <v-form ref="form" @submit.prevent="handleFormSubmit">
    <v-layout>
      <v-text-field label="Nombre" v-model="formData.nombre" :rules="[(v) => !!v || 'Este campo no puede estar vacío']"></v-text-field>
    </v-layout>
    <v-layout>
      <v-text-field label="URL de la Imagen" v-model="formData.imagen" :rules="[$rules.isURL]"></v-text-field>
    </v-layout>
    <v-layout>
